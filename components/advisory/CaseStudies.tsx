...
const content = {
  ...
  es: {
    ...
    cases: [
      {
        number: '01',
        title: 'Evaluaci\u00f3n de Entrada al Mercado para un Grupo Manufacturero',
        situation:
      ...
      {
        number: '02',
        title: 'Mapeo de Actores Clave para una Delegaci\u00f3n Centroamericana',
        situation:
      ...
      {
        number: '05',
        title: 'Evaluaci\u00f3n de Socios para una Operaci\u00f3n Log\u00edstica',
        situation:
    ...
    <section className="py-section-mobile sm:py-section">
      ...
      {t.cases.map((cs, i) => {
        ...
        return (
          <div
            key={cs.number}
            className={isAlt ? 'bg-lightgray' : 'bg-white'}
          >
            <Container>
