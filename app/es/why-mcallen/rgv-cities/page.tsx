  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle: 'McAllen es el ancla, pero el VRG es una regi\u00f3n econ\u00f3mica \u2014 y cada ciudad aporta algo diferente a la mesa.',
        ...
        keyFacts: [
          ...
          { label: 'Ciudades del condado de Hidalgo', value: '7+ econom\u00edas distintas' },
        ],
        stakeholders: [
