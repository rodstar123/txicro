...
export const metadata = generatePageMetadata({
  ...
  description:
    "El corredor McAllen-Reynosa-Monterrey es una de las arterias comerciales m\u00e1s activas de Norteam\u00e9rica. A 2.5 horas de la capital industrial de M\u00e9xico.",
  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle:
          "2.5 horas separan a McAllen, Texas de Monterrey, la capital industrial de M\u00e9xico \u2014 y la relaci\u00f3n econ\u00f3mica entre estas dos ciudades define el comercio transfronterizo en el hemisferio occidental.",
        ...
        keyFacts: [
          ...
          {
            label: "Monterrey: capital industrial",
            value: "3a ciudad m\u00e1s grande de M\u00e9xico",
          },
          { label: "Cruces de puentes internacionales", value: "2 puentes" },
          {
            label: "Industrias clave",
            value: "Auto, Aero, Acero, Electr\u00f3nica",
          },
