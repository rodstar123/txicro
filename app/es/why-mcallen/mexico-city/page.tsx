...
export const metadata = generatePageMetadata({
  ...
  description:
    "La Ciudad de M\u00e9xico es donde se toman las decisiones de expansi\u00f3n. McAllen es donde se ejecutan. Conectando las sedes corporativas de CDMX con el portal fronterizo de Texas.",
  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle:
          "Las decisiones se toman en Polanco y Santa Fe. La ejecuci\u00f3n sucede en la frontera. McAllen conecta las sedes corporativas de Am\u00e9rica Latina con los Estados Unidos.",
        ...
        keyFacts: [
          ...
          {
            label: "CDMX: capital corporativa",
            value: "Am\u00e9rica Latina #1",
          },
          {
            label: "Tiempo de viaje v\u00eda Monterrey",
            value: "2\u20133 hrs por avi\u00f3n",
          },
          {
            label: "Ventaja de costos McAllen vs Houston/Dallas",
            value: "30\u201350% menor",
          },
        ...
        relatedCorridors: [
          ...
          {
            title: "Ciudades del Valle del R\u00edo Grande",
            href: "/es/why-mcallen/rgv-cities",
          },
        ],
      }}
    />
