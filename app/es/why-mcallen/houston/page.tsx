  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle: 'Cinco horas hasta el puerto de importaci\u00f3n-exportaci\u00f3n m\u00e1s grande de los Estados Unidos \u2014 y la capital energ\u00e9tica del mundo.',
        ...
        keyFacts: [
          ...
          { label: 'Tonelaje extranjero Puerto Houston', value: '#1 en EE.UU.' },
          { label: 'Exportaciones Puerto Houston', value: 'Puerto exportador l\u00edder' },
          { label: 'Empresas energ\u00e9ticas Houston', value: '5,000+' },
          { label: 'Poblaci\u00f3n metro Houston', value: '7+ millones' },
          { label: 'Especialidad puente Pharr', value: '#1 cruce agr\u00edcola EE.UU.' },
        ],
        stakeholders: [
          'Puerto de Houston',
        ...
        relatedCorridors: [
          ...
          { title: 'McAllen \u2194 Ciudad de M\u00e9xico', href: '/es/why-mcallen/mexico-city' },
        ],
      }}
    />
  );
