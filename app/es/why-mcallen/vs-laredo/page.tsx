...
export const metadata = generatePageMetadata({
  ...
  description:
    "Comparaci\u00f3n honesta de McAllen y Laredo como portales fronterizos de Texas para negocios internacionales. Diferentes fortalezas, diferentes ventajas.",
  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle:
          "Dos ciudades fronterizas de Texas. Dos portales leg\u00edtimos. Una comparaci\u00f3n honesta de lo que cada una ofrece \u2014 porque la elecci\u00f3n correcta depende de lo que su negocio realmente necesita.",
        ...
        keyFacts: [
          {
            label: "Laredo: puerto terrestre m\u00e1s activo",
            value: "Hemisferio Occidental #1",
          },
        ...
        comparison: [
          {
            category: "Funci\u00f3n Econ\u00f3mica Principal",
            mcallen:
              "Diversificada: gesti\u00f3n manufacturera, salud, servicios, comercio, educaci\u00f3n",
            laredo:
              "Concentrada: log\u00edstica de carga, transporte, corredur\u00eda aduanera",
          },
          {
            category: "Car\u00e1cter del Comercio Transfronterizo",
            mcallen:
              "Comercio gestionado \u2014 operaciones de planta gemela, supervisi\u00f3n de maquilas",
            laredo:
              "Comercio de tr\u00e1nsito \u2014 alto volumen de carga hacia interior de EE.UU.",
          },
          {
            category: "Costo de Vida",
            mcallen: "15\u201320% por debajo del promedio de Texas",
            laredo: "Aproximadamente en el promedio de Texas",
          },
          {
            category: "Fuerza Laboral Biling\u00fce",
            mcallen: "86% tasa biling\u00fce",
            laredo:
              "Alta tasa biling\u00fce, mezcla industrial m\u00e1s limitada",
          },
          {
            category: "Zona de Comercio Exterior",
            mcallen: "ZCE #12 \u2014 una de las m\u00e1s activas de EE.UU.",
            laredo: "ZCE #94",
          },
          {
            category: "Fuente de Talento Universitario",
            mcallen:
              "UTRGV \u2014 31,000+ matriculados, instituci\u00f3n de investigaci\u00f3n R1",
            laredo:
              "TAMIU \u2014 matr\u00edcula menor, programas en crecimiento",
          },
          {
            category: "Calidad de Vida",
            mcallen:
              "Consistentemente entre las ciudades m\u00e1s seguras y accesibles de EE.UU.",
            laredo: "Fuerza laboral m\u00e1s transitoria, menos amenidades",
          },
          {
            category: "Ciudad Mexicana m\u00e1s Cercana",
            mcallen: "Reynosa (15 min) / Monterrey (2.5 hrs)",
            laredo: "Nuevo Laredo (inmediata) / Monterrey (3 hrs)",
          },
        ],
        stakeholders: [
