  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle: 'El Tri\u00e1ngulo de Texas \u2014 conectando el portal fronterizo de McAllen con la capital tecnol\u00f3gica y el centro militar del centro de Texas.',
        ...
        keyFacts: [
          ...
          { label: 'Sedes tech Austin', value: 'Tesla, Oracle, Samsung, Apple' },
          { label: 'Tri\u00e1ngulo de Texas: PIB estatal', value: '~75%' },
          { label: 'Canal de talento UTRGV', value: 'Ingenier\u00eda, Negocios, Salud' },
        ],
        stakeholders: [
