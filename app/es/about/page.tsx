...
export const metadata = generatePageMetadata({
  ...
  description:
    "Noe Rodriguez — nacido y criado en McAllen, TX. Toda una vida en el Valle del R\u00edo Grande. Empresario, asesor de comercio transfronterizo y fundador de TXICRO.",
  path: "/es/about",
  locale: "es",
});
