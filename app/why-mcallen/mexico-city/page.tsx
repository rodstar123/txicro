  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle: 'The decisions are made in Polanco and Santa Fe. The execution happens on the border. McAllen connects Latin America\u2019s corporate headquarters to the United States.',
        ...
        keyFacts: [
          ...
          { label: 'McAllen cost advantage vs Houston/Dallas', value: '30\u201350% lower' },
