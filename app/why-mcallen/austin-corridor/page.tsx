  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle: 'The Texas Triangle \u2014 connecting McAllen\u2019s border gateway to the tech capital and military hub of Central Texas.',
        ...
        keyFacts: [
          ...
          { label: 'UTRGV talent pipeline', value: 'Engineering, Business, Healthcare' },
        ],
        stakeholders: [
