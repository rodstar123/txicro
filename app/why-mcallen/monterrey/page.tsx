...
export const metadata = generatePageMetadata({
  ...
  description:
    "The McAllen-Reynosa-Monterrey corridor is one of the most active trade arteries in North America. 2.5 hours to Mexico's industrial capital. Advisory from TXICRO.",
  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle:
          "2.5 hours separate McAllen, Texas from Monterrey, Mexico\u2019s industrial capital \u2014 and the economic relationship between these two cities defines cross-border commerce in the Western Hemisphere.",
        ...
        keyFacts: [
          ...
          {
            label: "Monterrey: industrial capital",
            value: "3rd largest city in Mexico",
          },
