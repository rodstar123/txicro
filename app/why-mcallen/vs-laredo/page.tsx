...
export const metadata = generatePageMetadata({
  ...
  description:
    "Honest comparison of McAllen and Laredo as Texas border gateways for international business. Different strengths, different advantages.",
  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle:
          "Two Texas border cities. Two legitimate gateways. An honest comparison of what each offers \u2014 because the right choice depends on what your business actually needs.",
        ...
        keyFacts: [
          {
            label: "Laredo: busiest land port",
            value: "Western Hemisphere #1",
          },
        ...
        comparison: [
          {
            category: "Primary Economic Function",
            mcallen:
              "Diversified: manufacturing mgmt, healthcare, services, retail, education",
            laredo:
              "Concentrated: freight logistics, trucking, customs brokerage",
          },
          {
            category: "Cross-Border Trade Character",
            mcallen:
              "Managed trade \u2014 twin-plant operations, maquiladora oversight",
            laredo:
              "Throughput trade \u2014 high-volume cargo transit to US interior",
          },
          {
            category: "Cost of Living",
            mcallen: "15\u201320% below Texas average",
            laredo: "Roughly at Texas average",
          },
          {
            category: "Bilingual Workforce",
            mcallen: "86% bilingual rate",
            laredo: "High bilingual rate, narrower industry mix",
          },
          {
            category: "Foreign Trade Zone",
            mcallen: "FTZ #12 \u2014 one of most active in the US",
            laredo: "FTZ #94",
          },
          {
            category: "University Talent Pipeline",
            mcallen: "UTRGV \u2014 31,000+ enrollment, R1 research institution",
            laredo: "TAMIU \u2014 smaller enrollment, growing programs",
          },
          {
            category: "Quality of Life",
            mcallen:
              "Consistently ranked among safest, most affordable US cities",
            laredo: "More transient workforce, fewer amenities",
          },
          {
            category: "Nearest Major Mexican City",
            mcallen: "Reynosa (15 min) / Monterrey (2.5 hrs)",
            laredo: "Nuevo Laredo (immediate) / Monterrey (3 hrs)",
          },
        ],
        stakeholders: [
