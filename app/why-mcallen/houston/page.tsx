  ...
  return (
    <CorridorDetailPage
      ...
      corridor={{
        ...
        subtitle: 'Five hours to the largest import-export port in the United States \u2014 and the energy capital of the world.',
        ...
        relatedCorridors: [
          ...
          { title: 'McAllen \u2194 Mexico City', href: '/why-mcallen/mexico-city' },
        ],
      }}
    />
  );
