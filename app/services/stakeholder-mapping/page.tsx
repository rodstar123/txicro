...
const serviceSchema = {
  ...
  description: 'Identify and sequence relationships with key stakeholders in Texas — government agencies, chambers, EDOs, and private sector partners.',
  ...
  return (
    <>
      ...
      breadcrumbs={[
        ...
        { label: 'Stakeholder Mapping', href: '/services/stakeholder-mapping' },
      ]}
      service={{
